    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'usuarios',
                'permissions': (('administrar_modulos', 'Puede administrar módulos (permiso global de módulo)'), ('aprobar_reservas', 'Puede aprobar reservas'), ('gestionar_pagos', 'Puede gestionar pagos')),
            },
        ),
    ]
