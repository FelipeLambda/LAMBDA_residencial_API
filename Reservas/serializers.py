...
class ReservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reservation
        fields = ['id', 'apartamento', 'area', 'fecha_inicio', 'fecha_fin', 'status', 'created_by', 'approved_by', 'notas', 'creado', 'modificado']
        read_only_fields = ['status', 'created_by', 'approved_by', 'creado', 'modificado']
