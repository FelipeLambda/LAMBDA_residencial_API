...
class MaintenanceRequest(BaseModel):
    ...
    area = models.ForeignKey('Reservations.CommonArea', on_delete=models.SET_NULL, null=True, blank=True, related_name='mantenimientos', verbose_name='Área común (si aplica)')
