...
class Visit(BaseModel):
    ...
    apartamento = models.ForeignKey('Apartments.Apartamento', on_delete=models.SET_NULL, null=True, blank=True, related_name='visitas', verbose_name='Apartamento a visitar')
