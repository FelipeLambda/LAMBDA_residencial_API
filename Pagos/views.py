...
from Usuarios.permissions import CanMarkPayments, PaymentOwnerOrManager
...
class PaymentListCreateAPIView(APIView):
    ...
    def get(self, request):
        ...
        if request.user.has_perm('Pagos.view_pago_all'):
...
class PaymentDetailAPIView(APIView):
    ...
    def put(self, request, pk):
        ...
        if not request.user.has_perm('Pagos.mark_pago'):
